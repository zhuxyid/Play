...
pre_install(){
    ...
    read -p "(Default password: zhuxyid.com):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="zhuxyid.com"
    echo
    echo "---------------------------"
...
install(){
    ...
    echo
    echo "Welcome to visit:https://github.com/zhuxyid/play/Shadowsocks.md"
    echo "Enjoy it!"
    echo
}
